...
export default function Projects() {
    return (
        <section
            id="projects"
            className="scroll-mt-[70px] bg-[linear-gradient(45deg,#595CFF,#717FFF,#96B3FF,#AED5FF,#C6F8FF)]"
        >
            <div className="container flex flex-col gap-4 ">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-2 lg:items-stretch gap-4">
                    <Link href="https://upria.sence1.com/" target="_blank">
                        <div className="border flex flex-col gap-4 border-white p-6 rounded-2xl h-full flex-1">
                    ...
                    >
                        <div className="border flex flex-col gap-4 border-white p-6 rounded-2xl h-full flex-1">
                            ...
                            />
                            <p>
                                This was my online portfolio from 2022 to 2024
                                to showcase my practice projects and my skills
                    ...
                    >
                        <div className="border flex flex-col gap-4 border-white p-6 rounded-2xl h-full flex-1">
                            ...
                            />
                            <p>
                                A responsive and keyboard accessible component
                                in plain HTML, CSS, JavaScript (JQuery).
                            </p>
                            <p>Tech Stack:</p>
                            <ul className="flex flex-wrap gap-y-2 text-dark-grey">
                                <li className="border rounded-full p-2 mr-3">
